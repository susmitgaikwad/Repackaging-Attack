.class Landroid/support/v4/view/v$4;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroid/support/v4/view/v;->a()V
.end annotation
...
.method constructor <init>(Landroid/support/v4/view/v;)V
    ...
    .prologue
    .line 422
    iput-object p1, p0, Landroid/support/v4/view/v$4;->a:Landroid/support/v4/view/v;
    ...
    iput-object v0, p0, Landroid/support/v4/view/v$4;->b:Landroid/graphics/Rect;
...
.method public a(Landroid/view/View;Landroid/support/v4/view/ab;)Landroid/support/v4/view/ab;
    ...
    .line 443
    :cond_0
    iget-object v2, p0, Landroid/support/v4/view/v$4;->b:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Landroid/support/v4/view/v$4;->a:Landroid/support/v4/view/v;

    invoke-virtual {v3}, Landroid/support/v4/view/v;->getChildCount()I
    ...
    .line 450
    iget-object v4, p0, Landroid/support/v4/view/v$4;->a:Landroid/support/v4/view/v;

    .line 451
    invoke-virtual {v4, v1}, Landroid/support/v4/view/v;->getChildAt(I)Landroid/view/View;

    move-result-object v4

    invoke-static {v4, v0}, Landroid/support/v4/view/s;->b(Landroid/view/View;Landroid/support/v4/view/ab;)Landroid/support/v4/view/ab;
