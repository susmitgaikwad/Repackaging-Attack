...
.field c:Landroid/support/v7/widget/ShareActionProvider$a;

.field private d:I

.field private final e:Landroid/support/v7/widget/ShareActionProvider$c;

.field private f:Landroid/support/v7/widget/e$e;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .prologue
    .line 196
    invoke-direct {p0, p1}, Landroid/support/v4/view/c;-><init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->e:Landroid/support/v7/widget/ShareActionProvider$c;
...
.method private g()V
    ...
    .prologue
    .line 382
    iget-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->c:Landroid/support/v7/widget/ShareActionProvider$a;
    ...
    .line 385
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->f:Landroid/support/v7/widget/e$e;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ShareActionProvider;->f:Landroid/support/v7/widget/e$e;
    ...
    invoke-static {v0, v1}, Landroid/support/v7/widget/e;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/support/v7/widget/e;

    move-result-object v0

    .line 389
    iget-object v1, p0, Landroid/support/v7/widget/ShareActionProvider;->f:Landroid/support/v7/widget/e$e;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/e;->a(Landroid/support/v7/widget/e$e;)V
...
.method public a()Landroid/view/View;
    ...
    invoke-static {v1, v2}, Landroid/support/v7/widget/e;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/support/v7/widget/e;

    move-result-object v1

    .line 224
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ActivityChooserView;->setActivityChooserModel(Landroid/support/v7/widget/e;)V
    ...
    .line 232
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ActivityChooserView;->setProvider(Landroid/support/v4/view/c;)V
...
.method public a(Landroid/content/Intent;)V
    ...
    .line 349
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/e;->a(Landroid/content/Intent;)V
...
.method public a(Landroid/view/SubMenu;)V
    ...
    invoke-static {v0, v2}, Landroid/support/v7/widget/e;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/support/v7/widget/e;
    ...
    .line 262
    invoke-virtual {v2}, Landroid/support/v7/widget/e;->a()I

    move-result v4

    .line 263
    iget v0, p0, Landroid/support/v7/widget/ShareActionProvider;->d:I
    ...
    .line 267
    invoke-virtual {v2, v0}, Landroid/support/v7/widget/e;->a(I)Landroid/content/pm/ResolveInfo;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/ShareActionProvider;->e:Landroid/support/v7/widget/ShareActionProvider$c;
...
.method public a(Ljava/lang/String;)V
    ...
    .line 321
    invoke-direct {p0}, Landroid/support/v7/widget/ShareActionProvider;->g()V
