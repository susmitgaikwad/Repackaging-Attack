...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 172
    iget-object v1, p0, Landroid/support/v7/widget/h;->f:Landroid/support/v7/widget/bk;

    if-nez v1, :cond_0

    .line 173
    new-instance v1, Landroid/support/v7/widget/bk;

    invoke-direct {v1}, Landroid/support/v7/widget/bk;-><init>()V

    iput-object v1, p0, Landroid/support/v7/widget/h;->f:Landroid/support/v7/widget/bk;
    ...
    .line 180
    iput-boolean v0, v1, Landroid/support/v7/widget/bk;->d:Z

    .line 181
    iput-object v2, v1, Landroid/support/v7/widget/bk;->a:Landroid/content/res/ColorStateList;
    ...
    .line 185
    iput-boolean v0, v1, Landroid/support/v7/widget/bk;->c:Z

    .line 186
    iput-object v2, v1, Landroid/support/v7/widget/bk;->b:Landroid/graphics/PorterDuff$Mode;

    .line 189
    :cond_2
    iget-boolean v2, v1, Landroid/support/v7/widget/bk;->d:Z

    if-nez v2, :cond_3

    iget-boolean v2, v1, Landroid/support/v7/widget/bk;->c:Z
    ...
    invoke-static {p1, v1, v2}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bk;[I)V
...
.method private d()Z
    ...
    .line 154
    iget-object v2, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bk;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 99
    iget-object v0, p0, Landroid/support/v7/widget/h;->e:Landroid/support/v7/widget/bk;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/h;->e:Landroid/support/v7/widget/bk;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bm;->h(I)Z
    ...
    .line 60
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/bm;->f(I)Landroid/content/res/ColorStateList;
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    .line 138
    iget-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bk;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bk;
...
.method c()V
    ...
    .line 126
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/h;->e:Landroid/support/v7/widget/bk;
    ...
    .line 127
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bk;[I)V

    goto :goto_0

    .line 129
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/h;->d:Landroid/support/v7/widget/bk;
