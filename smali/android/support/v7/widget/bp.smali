...
# static fields
.field private static i:Landroid/support/v7/widget/bp;
...
.method private constructor <init>(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bp;->c:Ljava/lang/Runnable;
...
.method private a()V
    ...
    .line 173
    sget-object v0, Landroid/support/v7/widget/bp;->i:Landroid/support/v7/widget/bp;

    if-ne v0, p0, :cond_0

    .line 174
    sput-object v1, Landroid/support/v7/widget/bp;->i:Landroid/support/v7/widget/bp;

    .line 175
    iget-object v0, p0, Landroid/support/v7/widget/bp;->g:Landroid/support/v7/widget/bq;
    ...
    .line 177
    iput-object v1, p0, Landroid/support/v7/widget/bp;->g:Landroid/support/v7/widget/bq;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bp;->c:Ljava/lang/Runnable;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bp;->d:Ljava/lang/Runnable;
...
.method static synthetic a(Landroid/support/v7/widget/bp;)V
    .locals 0
...
.method static synthetic a(Landroid/support/v7/widget/bp;Z)V
    .locals 0

    .prologue
    .line 39
    invoke-direct {p0, p1}, Landroid/support/v7/widget/bp;->a(Z)V
...
.method public static a(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v0}, Landroid/support/v7/widget/bp;->a()V
...
.method private a(Z)V
    ...
    .line 151
    :cond_1
    sput-object p0, Landroid/support/v7/widget/bp;->i:Landroid/support/v7/widget/bp;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bp;->g:Landroid/support/v7/widget/bq;
    ...
    iget-boolean v4, p0, Landroid/support/v7/widget/bp;->h:Z

    iget-object v5, p0, Landroid/support/v7/widget/bp;->b:Ljava/lang/CharSequence;

    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/bq;->a(Landroid/view/View;IIZLjava/lang/CharSequence;)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/bp;->d:Ljava/lang/Runnable;
    ...
    invoke-static {v0}, Landroid/support/v4/view/s;->o(Landroid/view/View;)I
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 103
    invoke-direct {p0, v1}, Landroid/support/v7/widget/bp;->a(Z)V
