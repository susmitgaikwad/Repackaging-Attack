...
.method private f()I
    ...
    .line 1135
    .line 1137
    iget-object v0, p0, Landroid/support/v7/widget/ar;->c:Landroid/support/v7/widget/al;
    ...
    :goto_0
    invoke-virtual {p0, v5, v0}, Landroid/support/v7/widget/ar;->a(Landroid/content/Context;Z)Landroid/support/v7/widget/al;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ar;->c:Landroid/support/v7/widget/al;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ar;->A:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v6}, Landroid/support/v7/widget/al;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/al;->setAdapter(Landroid/widget/ListAdapter;)V

    .line 1162
    iget-object v0, p0, Landroid/support/v7/widget/ar;->c:Landroid/support/v7/widget/al;

    iget-object v6, p0, Landroid/support/v7/widget/ar;->B:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v0, v6}, Landroid/support/v7/widget/al;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/al;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    .line 1183
    iget-object v0, p0, Landroid/support/v7/widget/ar;->c:Landroid/support/v7/widget/al;

    iget-object v6, p0, Landroid/support/v7/widget/ar;->E:Landroid/support/v7/widget/ar$c;

    invoke-virtual {v0, v6}, Landroid/support/v7/widget/al;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ar;->C:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    .line 1191
    iget-object v7, p0, Landroid/support/v7/widget/ar;->w:Landroid/view/View;
    ...
    .line 1202
    iget v8, p0, Landroid/support/v7/widget/ar;->x:I
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/al;->a(IIIII)I
    ...
    .line 1303
    iget-object v1, p0, Landroid/support/v7/widget/ar;->c:Landroid/support/v7/widget/al;

    invoke-virtual {v1}, Landroid/support/v7/widget/al;->getPaddingTop()I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/widget/ar;->c:Landroid/support/v7/widget/al;

    .line 1304
    invoke-virtual {v2}, Landroid/support/v7/widget/al;->getPaddingBottom()I
...
.method public a()V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/al;->setSelection(I)V
...
.method public b()V
    ...
    .line 752
    invoke-direct {p0}, Landroid/support/v7/widget/ar;->e()V
    ...
    .line 754
    iput-object v1, p0, Landroid/support/v7/widget/ar;->c:Landroid/support/v7/widget/al;
...
.method public i(I)V
    ...
    .line 810
    invoke-virtual {p0}, Landroid/support/v7/widget/ar;->c()Z
