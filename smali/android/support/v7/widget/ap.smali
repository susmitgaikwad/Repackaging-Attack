...
.method private a()V
    ...
    .line 219
    iget-object v4, v0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/ap$a;

    invoke-virtual {v4, v0, v3}, Landroid/support/v7/widget/ap$a;->a(Landroid/support/v7/widget/RecyclerView;Z)V

    .line 220
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/ap$a;
    ...
    .line 234
    :cond_1
    iget-object v8, v0, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/ap$a;
    ...
    .line 250
    iput-object v0, v1, Landroid/support/v7/widget/ap$b;->d:Landroid/support/v7/widget/RecyclerView;
...
.method private a(Landroid/support/v7/widget/RecyclerView;J)V
    ...
    .line 321
    :cond_2
    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/ap$a;

    .line 322
    const/4 v0, 0x1

    invoke-virtual {v1, p1, v0}, Landroid/support/v7/widget/ap$a;->a(Landroid/support/v7/widget/RecyclerView;Z)V
    ...
    .line 332
    invoke-direct {p0, p1, v2, p2, p3}, Landroid/support/v7/widget/ap;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$w;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private a(Landroid/support/v7/widget/ap$b;J)V
    ...
    invoke-direct {p0, v2, v3, v0, v1}, Landroid/support/v7/widget/ap;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$w;
    ...
    invoke-direct {p0, v0, p2, p3}, Landroid/support/v7/widget/ap;->a(Landroid/support/v7/widget/RecyclerView;J)V
...
.method static a(Landroid/support/v7/widget/RecyclerView;I)Z
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/widget/ag;->d(I)Landroid/view/View;
...
.method private b(J)V
    ...
    .line 355
    iget-object v2, v0, Landroid/support/v7/widget/ap$b;->d:Landroid/support/v7/widget/RecyclerView;
...
.method a(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    .line 184
    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->A:Landroid/support/v7/widget/ap$a;
